...
public class TopDownCarController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Transform dustParticlesTransform = transform.Find("Dust Particles");
        ...
        if(dustParticlesTransform != null )
        {
            ...
            {
                Debug.LogWarning("Dust Particles child does not have a ParticleSystem component.");
            }
        }
        else
        {
            Debug.LogWarning("Could not find child object named 'Dust Particles'.");
        }
